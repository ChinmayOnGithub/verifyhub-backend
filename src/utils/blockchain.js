...
// Load Certification contract ABI from the build folder
...
try {
  ...
  console.log("Loaded Certification ABI methods:", contractABI.map(method => method.name));
} catch (error) {
...
try {
  ...
  console.log("Using Certification contract address:", contractAddress);
} catch (error) {
