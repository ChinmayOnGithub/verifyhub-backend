...
// src/utils/pdfReaderUtils.js (modified)
import { createHash } from 'crypto';
import Certificate from '../models/certificate.model.js'; // Adjust path as needed

export const computePDFHash = (pdfBuffer) => {
  return createHash('sha256').update(pdfBuffer).digest('hex');
};

export const verifyPDFHash = async (certificateId, computedHash) => {
  try {
    ...
    return certificate.ipfsHash === computedHash;
